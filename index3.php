...
<head>
  ...
  <title>Sistem Inventory Asset | PT. Sentosa Ultra Gasindo</title>
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index3.php">
        ...
        <div class="sidebar-brand-text mx-2">PT. SENTOSA ULTRA GASINDO</div>
      </a>
  ...
  <!--sidebar start-->
	   ...
	   <li class="nav-item active">
        ...
        <div id="collapseData" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="?page=gudang">Data Gudang</a>
            <a class="collapse-item" href="?page=jenisbarang">Jenis Asset</a>
            <a class="collapse-item" href="?page=satuanbarang">Satuan Asset</a>
	    
	    <a class="collapse-item" href="?page=relasi">Data Relasi</a>
        ...
        <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Menu:</h6>
            <a class="collapse-item" href="?page=barangmasuk">Asset Masuk</a>
            <a class="collapse-item" href="?page=barangkeluar">Asset Keluar</a>
	    <a class="collapse-item" href="?page=supplier">Asset Relasi</a>
      ...
      <div class="sidebar-heading">
        ...
        <div id="collapseLaporan" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="?page=laporan_supplier">Laporan Asset Relasi</a>
            <a class="collapse-item" href="?page=laporan_barangmasuk">Laporan Asset Masuk</a>
            <a class="collapse-item" href="?page=laporan_gudang">Laporan Asset Gudang</a>
            <a class="collapse-item" href="?page=laporan_barangkeluar">Laporan Asset Keluar</a> 
          </div>
        </div>
      </li>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
		...
		<div class="container">
			<div class="link">
				<img src="img/SG.png" width='225' height='45' >
			</div>
		</div>
        ...
        <div class="container-fluid">
		 ...
		 <section class="content">
			...
			if ($page == "relasi") {
				   if ($aksi == "") {
					   include "page/relasi/relasi.php";
				   }
				    if ($aksi == "tambahrelasi") {
					   include "page//relasi/tambahrelasi.php";
				   }
				    if ($aksi == "ubahrelasi") {
					   include "page/relasi/ubahrelasi.php";
				   }
				   
				    if ($aksi == "hapusrelasi") {
					   include "page/relasi/hapusrelasi.php";
				   }
			   }				
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span readonly>Copyright &copy; 2022 . SUG Filling Kalimalang</span>
          </div>
...
jQuery(document).ready(function($) {
   $('#cmb_barang').change(function() { // Jika Select Box id provinsi dipilih
     ...
     $.ajax({
            type: 'POST', // Metode pengiriman data menggunakan POST
          url: 'page/supplier/get_barang2.php', // File yang akan memproses data
         data: 'tamp=' + tamp, // Data yang akan dikirim ke file pemroses
         success: function(data) { // Jika berhasil
...
<script type="text/javascript">
 ...
 <script type="text/javascript">
    ...
    $('#Myform3').submit(function() {
        $.ajax({
            type: 'POST',
            url: 'page/laporan/export_laporan_supplier_excel.php',
            data: $(this).serialize(),
            success: function(data) {
             $(".tampung3").html(data);
             $('.table').DataTable();
